...
router.get('/getName', (req, res) => {
    // db.query(`select classId, className  from  class_specialty_view WHERE courseId = ${id} group by classId;`, )
    db.query(`select classId, className  from  class_specialty_view WHERE courseId = ${req.query.courseId} group by classId;`, [], data => {
        console.log('')
